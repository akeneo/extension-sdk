...
spriteImg.style.left = '-9999px';
spriteImg.style.top = '-9999px';
spriteImg.style.width = '0';
spriteImg.style.height = '0';
...
// Also initialize if image is already cached
...
function initializeGame() {
  ...
  function showGoMenu() {
    ...
    if (scoreText) scoreText.innerHTML = "You scored " + score + " points!";
  }
