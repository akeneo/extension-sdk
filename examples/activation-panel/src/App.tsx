...
const ProductBadge = styled.div`
  ...
  border: 1px solid ${getColor('blue', 60)};
  border-radius: 4px;
  margin-bottom: 20px;
  font-size: ${getFontSize('small')};
  color: ${getColor('blue', 140)};
`;
...
function App() {
  ...
  return (
    <PageContainer>
      <SectionTitle>
        <SectionTitle.Title>Channel Orders for Product</SectionTitle.Title>
      </SectionTitle>

      {productSku && (
        <ProductBadge>
          <strong>Product SKU:</strong> {productSku}
        </ProductBadge>
      )}
